...
import { ABOUT_ME, AboutMeStructuredData } from "@portfolio/data/about-me";
import { AboutMeMetadata } from "@portfolio/metadata/about-me-metadata";
import Image from "next/image";
import Script from "next/script";

export const metadata = AboutMeMetadata;
...
export default function Page() {
  ...
  return (
    <>
      <Script
        id="about-me-structured-data"
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(AboutMeStructuredData),
        }}
      />
        ...
        <div className="flex-1 flex lg:flex-row flex-col justify-between lg:pt-0 pt-8">
          <div className="flex flex-col items-center justify-center">
            <Image
              src={data.image}
              alt={data.name}
              className="lg:size-[480px] border border-transparent lg:rounded-xl size-80 rounded-full"
              height={400}
              width={400}
            />
          </div>
