import { INTRO, PersonStructuredData } from "@portfolio/data/intro";
      ...
      <div className="h-full w-full flex flex-col items-center justify-center">
        <div className="flex lg:flex-row w-full flex-col-reverse justify-between lg:px-12">
          <main className="flex flex-col items-start justify-center lg:px-0 px-8 lg:w-[60%] lg:pb-0 pb-12">
            <h3 className="text-5xl font-extrabold text-left w-full my-4">
              Hi, I&apos;am {data.name} 👋
            </h3>
            ...
            <div className="flex flex-row gap-2 mt-2 mb-1 items-center">
              <Localisation className="size-5" /> Saint Etienne, France{" "}
            </div>
            <div className="flex flex-row gap-2 items-center mt-1 mb-2">
              <div className="size-2 border border-transparent rounded-full bg-green-400" />{" "}
            ...
            <button className="bg-black text-white border border-transparent rounded-xl px-4 py-2">
              Download resume
            </button>
          </main>
